...
const BrunswickPendulumProdactScreen = ({navigation, route}) => {
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem('BrunswickPendulumProdactScreen', jsonData);
  ...
  const getData = async () => {
    try {
      const jsonData = await AsyncStorage.getItem(
        'BrunswickPendulumProdactScreen',
      );
      if (jsonData !== null) {
  ...
  ////////////////////////////
  let baseUrl = `https://miraculous-eminent-bliss.space/XKV9mh65?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}`;
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../../assets/png/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../../assets/png/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default BrunswickPendulumProdactScreen;
